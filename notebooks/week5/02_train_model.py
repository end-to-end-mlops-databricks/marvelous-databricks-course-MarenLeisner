...
from taxinyc.model import TaxiFareModelWrapper
...
train_set = spark.table(f"{catalog_name}.{schema_name}.train_set_ma").toPandas()#.drop("OverallQual", "GrLivArea", "GarageCars")
...
with mlflow.start_run(tags={"branch": "week5",
    ...
    conda_env = _mlflow_conda_env(
        ...
        additional_pip_deps=["code/taxinyc-0.0.1-py3-none-any.whl",
                             ],
