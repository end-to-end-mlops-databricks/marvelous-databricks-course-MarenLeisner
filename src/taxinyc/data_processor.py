...
class DataProcessor:
    ...
    def load_data(self, sparksession, table: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise ValueError(f"Failed to load table {table}: {str(e)}") from e
    ...
    def split_data(self, test_size: float = 0.2, random_state: int = 42, stratify: bool = False) -> tuple:
        ...
        return train_test_split(self.X, self.y, test_size=test_size, random_state=random_state, stratify=stratify_param)
